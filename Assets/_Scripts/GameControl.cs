...
public class GameControl : MonoBehaviour {
    ...
    public GameObject rewindSfxObj;
    #endregion
    ...
    void Start () {
        ...
        //Get rewind obj ref
        rewindSfxObj = AudioControl.instance.transform.GetChild(0).gameObject;
